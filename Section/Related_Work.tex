\section{Introduction to US and US Quality Assurance}\label{introduction_to_us}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.7]{2.0_Quality_US_framework_that_define_13_criteria_for_US_quality_overview}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{2.0_Conceptual_model_of_US}
