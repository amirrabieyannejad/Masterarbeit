...
\subsection{QUS framework and AQUSA as Tool}\label{quality-framework}
...
\end{tabularx}
\captionof{table}{Quality User Story framework that defines 13 criteria for user story quality: details \cite{lucassen2016improving}}\label{tb:qus}
\endgroup
\end{figure}
