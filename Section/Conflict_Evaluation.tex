...
\begin{figure}[h]
	...
	\captionof{table}{Details of the count of correctly recognised and validated conflict pairs by the tool as ground truth}\label{tb:conflict_ground_truth}	
	\endgroup
\end{figure}
...
Table \ref{tb:tool} shows the aggregation of the US conflict pairs found in the main parts evaluated by the tool.
\begin{figure}[h]
	\begingroup
	\scriptsize
	\centering
	\includegraphics[scale=0.55]{Table/conflict_tool.png}
	\captionof{table}{Aggregation of the count of US conflict pairs in relation to the main parts assessed by the tool}\label{tb:conflict_tool}
	\endgroup
\end{figure}
...
\begin{figure}[h]
	...
	\captionof{table}{Detail on the count of discrepancies between the result provided by the tool and the ground truth}\label{tb:conflict_difference}
