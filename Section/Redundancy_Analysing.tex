...
\begin{figure}[h]
	\centering 
	\includegraphics[scale=0.2]{redundancyItems_diagram}
	\caption{Sequence diagram for the classes to save redundancy elements accordingly}\label{fig:redundancyItems_diagram}
\end{figure} 
...
\begin{figure}[h]
	\centering 
	\includegraphics[scale=0.35]{report_extractor_diagram}
	\caption{Sequence diagram for the process of extracting redundancy items founded by the CDA tool.}\label{fig:report_extractor_diagram}
\end{figure} 
