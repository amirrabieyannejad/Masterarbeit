...
% explain about Exceptions, that you implemented

\subsubsection*{User Story Structure}
% explain about benefit and main segment, and define their scope
...
\begin{landscape}
	...
	\begin{figure}[h]
		...
		\begin{tabularx}{25cm}{X  X  X  X}
			...
			BenefitInBothUss\newline(testhigHlightRedundancies)&Provision of a CDA report for a US-pair where both USs have \enquote{benefit} part&Create a text report containing both USs with their respective main and benefit parts to analyse the parts on the basis of respective parts&Verifies the behaviour of the \textit{highlightRedundancies} method when both USs have benefits\\
			
			noBenefitInBothUss\newline(testhigHlightRedundancies)&Provision of a CDA report for a US-pair where both USs don't have \enquote{benefit} part&Create a text report containing both USs with their respective main part to analyse the main part on the basis of respective parts&Verifies the behaviour of the \textit{highlightRedundancies} method when both USs have benefits\\
