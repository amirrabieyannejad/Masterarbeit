...
\lstdefinestyle{pseudocode}{
	...
	morekeywords={if, then, else, while, do, end, new},
	deletekeywords={int, float, char},
	columns=flexible,
	keepspaces=true,
	numbers=left,
...
\newenvironment{MyListing}{
	\lstset{style=pseudocode} % Set the language, adjust as needed
...
\input{Section/Conflict_Analysing}
